    ...
    <div className="tab-panel">
      ...
      <div className="card mb-lg" style={{ background: 'linear-gradient(135deg,var(--primary-50),#fff)' }}>
        <div className="flex items-center gap-md">
          <div>
            ...
            <div style={{ color: 'var(--gray-500)', fontSize: 'var(--font-sm)' }}>ယနေ့စျေး: ၅၂,၅၀၀ ကျပ်/တင်း</div>
          </div>
        </div>
      </div>
      ...
      <div className="grid-3 mb-lg">
        <div className="forecast-card">
          ...
          <div className="forecast-confidence">ယခင် ၇ ရက်: +၃.၂%</div>
        </div>
        <div className="forecast-card">
          <div className="forecast-period">လာမည့် ၇ ရက် ခန့်မှန်း</div>
          <div className="forecast-direction up">↑</div>
          <div className="forecast-label">ဆက်တက်နိုင်</div>
          <div className="forecast-confidence">ယုံကြည်မှု: ၇၅%</div>
        </div>
        <div className="forecast-card">
          ...
          <div className="forecast-confidence">ယုံကြည်မှု: ၆၀%</div>
        </div>
      </div>
      ...
      <div className="recommendation-card wait mb-lg">
        ...
        <div className="recommendation-reason">နှမ်းစျေးနှုန်း လာမည့် ၇ ရက်အတွင်း ၅-၈% ထပ်တက်နိုင်ခြေရှိပါသည်။ ဝယ်လိုအား မြင့်တက်နေပြီး ရာသီဥတုအခြေအနေ ကောင်းမွန်နေပါသည်။</div>
      </div>
      ...
      <div className="card mb-lg">
        ...
        <div className="flex flex-col gap-md">
          <div className="insight-card" style={{ borderLeftColor: 'var(--trend-up)' }}>
            <div className="insight-text"><strong>စျေးကွက်လမ်းကြောင်း:</strong> ယခင် ၇ ရက်အတွင်း စျေးနှုန်း အဆက်မပြတ် တက်နေပါသည်။</div>
          </div>
